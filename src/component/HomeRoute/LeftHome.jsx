  ...
  return (
    <>
      ...
      <Card className='text-white bg-white border-0 mb-5'>
            ...
            <hr style={{ backgroundColor: "black", height: "1px", border: "none",margin: "0" }} />


            <Card.Body className='hoverElement py-1'>
                <Card.Text className='textSmall fw-bold d-flex justify-content-between text-secondary'>
                    Chi ha visitato il tuo profilo? <span className='text-info ms-2'>235</span>
                </Card.Text>
            </Card.Body>

            <Card.Body className='hoverElement py-1'>
                <Card.Text className='textSmall fw-bold d-flex justify-content-between text-secondary'>
                    Visualizzazoni del tuo profilo <span className='text-info ms-2'>320</span>
                </Card.Text>
            </Card.Body>
